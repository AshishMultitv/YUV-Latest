...
//            self.navigationController?.pushViewController(moreViewController, animated: true)
    ...
    func setimageincarouseview()
    {
        ...
        setuptalnehutincorasal()
        
        
        
    }
    
    func setuptalnehutincorasal() {
        if(LoginCredentials.Isauditionenabel) {
                  let urltalent = URL(string: "http://dapsj6yr92bve.cloudfront.net/Audition/Talent__hunt.jpg")
                imageCarouselView.statusarray.insert("0", at: 0)
                imageCarouselView.imageurlarry.insert(urltalent as? URL, at: 0)
                imageCarouselView.textarray.insert("", at: 0)
                imageCarouselView.textarraydes.insert("", at: 0)
                imageCarouselView.episodearray.insert("", at: 0)
         }
    }
    ...
    func clickcoresal(notification:NSNotification)
    {
        ...
        if(LoginCredentials.Isauditionenabel) {
            ...
            {
              self.actiononcoresalclick(index: index-1)
            }
...
//
//                        if(index == 0) {
//                    self.actiononcoresalclick(index: index)
//                        }
//                        else
//                        {
//                            self.actiononcoresalclick(index: index-1)
...
//            }
    ...
    func presetauditionview() {
        if(!Common.Islogin()) {
            Common.CheckUserloginandsubscribtion(viewcontrolerl: self)
            return
        }
        ...
        self.present(auditionViewController, animated: true, completion: nil)
    }
    
    func actiononcoresalclick(index:Int) {
