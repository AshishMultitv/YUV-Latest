...
class LoginViewController: UIViewController,GIDSignInDelegate,GIDSignInUIDelegate,UITextViewDelegate {
    ...
    @IBAction func Taptologin(_ sender: UIButton) {
        ...
        else if(!(Common.isEmptyOrWhitespace(testStr: Password_txtfld.text!)))
        {
            EZAlertController.alert(title: "Please enter Password")
             ...
             MatomoTracker.shared.track(eventWithCategory: "User", action: "click", name: "sign_in", value: 1)
            type = "phone"
            //gotouserintersetview()
            getloginapi()
        }
    ...
    @IBAction func TAptoskip(_ sender: UIButton) {
        MatomoTracker.shared.track(eventWithCategory: "User", action: "click", name: "skip login", value: 1)
        self.gotohomeacreen()   
    ...
    @IBAction func Taptogoogle(_ sender: UIButton) {
        ...
        MatomoTracker.shared.track(eventWithCategory: "User", action: "click", name: "google_sign_in", value: 1)
...
//                        }
    ...
    @IBAction func TAptoFacebook(_ sender: UIButton) {
        ...
        MatomoTracker.shared.track(eventWithCategory: "User", action: "click", name: "facebook_sign_in", value: 1)
        type = "social"
        fboremail = "facebook"
