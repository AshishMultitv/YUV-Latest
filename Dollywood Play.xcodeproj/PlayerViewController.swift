...
GCKRemoteMediaClientListener, GCKRequestDelegate  {
    ...
    @IBAction func Taptosubmitratingview(_ sender: UIButton) {
         MatomoTracker.shared.track(eventWithCategory: "content", action: "rate", name:tilttext , value: Float(self.submitratingbar.value))
        ratingview.isHidden = true
        self.Submitrating()
    ...
    func getplayerurl() {
        ...
        MatomoTracker.shared.track(eventWithCategory: "content", action: "play", name: tilttext, value: 1)
        Isendcomment = false
   ...
   //         return
    ...
    func playvideo(url:String)
    {
        ...
        DispatchQueue.main.async { () -> Void in
            ...
            let rectsecuritylabel = CGRect(origin: CGPoint(x: 20,y :120), size: CGSize(width: 100, height: 50))
    ...
    func rotateddd()
    {
        if(self.avLayer != nil)
        {
            if UIDeviceOrientationIsLandscape(UIDevice.current.orientation)
            {
                ...
                let rectsecuritylabel = CGRect(origin: CGPoint(x: 20,y :self.view.frame.size.height/2+40), size: CGSize(width: 100, height: 50))
                self.securitylabel.frame = rectsecuritylabel
        ...
        if (dict.count>0)
        {
            ...
            } else
            {
                ...
                else
                {
                    ...
                    MatomoTracker.shared.track(eventWithCategory: "content", action: "download", name: tilttext, value: 1)
    ...
    @IBAction func Taptoshare(_ sender: UIButton) {
        ...
        MatomoTracker.shared.track(eventWithCategory: "content", action: "share", name:tilttext , value: 1)
    ...
    @IBAction func Taptodislike(_ sender: UIButton) {
        ...
        if (dict.count>0)
        {
            ...
            if(!isdislike)
            {
                  MatomoTracker.shared.track(eventWithCategory: "content", action: "click", name: "dislike", value: 1)
            ...
            {
                  MatomoTracker.shared.track(eventWithCategory: "content", action: "click", name: "dislike", value: 0)
                dislikecount =  dislikecount - 1
                parameters = [
                    "device": "ios",
                    "type": "video",
        ...
        if (dict.count>0)
        {
            ...
            if(!islike)
            {
                ...
                likecount =  likecount + 1
                 ...
                 MatomoTracker.shared.track(eventWithCategory: "content", action: "click", name: "like", value: 1)
            ...
            else
            {
                ...
                likecount =  likecount - 1
                 MatomoTracker.shared.track(eventWithCategory: "content", action: "click", name: "like", value: 0)
                //dislikecount =  dislikecount + 1
            }
